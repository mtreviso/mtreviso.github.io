...
Before that, I interned at Unbabel, where I helped to develop [OpenKiwi](https://github.com/Unbabel/OpenKiwi){:target="\_blank"}, a MT Quality Estimation tool that received the best Demo Paper Award at ACL19 and was the backbone of our winning submission to the [WMT-QE19 shared task](https://www.statmt.org/wmt19/qe-results.html){:target="\_blank"}. 

I obtained my M.Sc. in Computer Science and Computational Mathematics at the [University of São Paulo (USP)](https://www.icmc.usp.br/en/){:target="\_blank"} under the supervision of Prof. [Sandra M. Aluísio](https://scholar.google.com.br/citations?user=9mDOHngAAAAJ&hl=pt-BR){:target="\_blank"}. 
My research involved using [convolutional and recurrent neural nets with CRFs]((https://github.com/mtreviso/deepbondd/){:target="\_blank"}) to detect sentence boundaries and speech disfluences in speech transcripts.
